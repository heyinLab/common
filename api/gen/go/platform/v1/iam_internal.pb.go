...
type TenantPermissionTreeNode struct {
	...
	ProductCode   *uint32                     `protobuf:"varint,12,opt,name=product_code,json=productCode,proto3,oneof" json:"product_code,omitempty"`
...
func (x *TenantPermissionTreeNode) GetProductCode() uint32 {
...
const file_platform_v1_iam_internal_proto_rawDesc = "" +
	...
	"\fproduct_code\x18\f \x01(\rH\bR\vproductCode\x88\x01\x01\x12\x1d\n" +
	"\n" +
